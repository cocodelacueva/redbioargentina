...
class lqva_widgets_category_publicaciones extends WP_Widget {
    /**
     * Sets up the widgets name etc
     */
    public function __construct() {
        $widget_options = array(
            'description'    => esc_html__( 'Muestra las ultimas publicaciones', 'lang' ),
            'title'          => esc_html__( 'Publicaciones' ),
            'limit'          => 3,
            'show_thumbnail' => true,
            'category'       => '1',
        );
        parent::__construct( 'lqva-widgets-category-publicaciones', esc_html__( 'lqva - Publicaciones recientes', 'lang' ), $widget_options );
    }
    /**
     * Outputs the options form on admin
     *
